...
export const SectionBlockchainT = ({chooseBlockchain}: SectionBlockchainProps) => {
  return (
    <CAdaptiveBox className="fade-in" padding="15px 20px 40px">
      ...
      <PBox display="grid" justifyContent="center" gridTemplateColumns="repeat(auto-fit, 225px)" margin="0 -8px">
        {blockchains.map(b => (
