...
import {itemImageT} from '../../page-item.styles';
...
export const SectionMainT = ({
  ...
  return (
    <CAdaptiveBox padding="15px 20px 40px">
      <PBox display="grid" gap="10px">
        ...
        <PBox display="grid" gap="16px">
          ...
          <PBox display="grid" gap="24px">
            ...
            <PBox display="grid" gridAutoFlow="column" justifyContent="start" gap="25px">
