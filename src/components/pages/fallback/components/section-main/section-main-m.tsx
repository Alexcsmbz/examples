...
export const SectionMainM = ({
  ...
  return (
    <CAdaptiveBox marginTop="48px" padding="0 20px 40px" className="fade-in">
      <PBox display="grid" justifyItems="center" gap="40px">
        <PBox display="grid" justifyItems="center" gap="16px">
          <img src={Image.rocket} width={179} height={131} alt="fallback rocket" />
