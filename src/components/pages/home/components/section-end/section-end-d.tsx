...
export const SectionEndD = ({marketItems}: {marketItems?: MarketItem[]}) => {
  ...
  return (
    <CAdaptiveBox maxWidth="1260px" padding="0 30px" className="fade-in">
      <PBox marginBottom="89px">
        ...
        <PBox margin="0 -12px" className={slickSliderWrapper({device: 'desktop'})}>
          <Slider {...getListingCarouselSettings({slidesToShow: 4})} className={listingSlider}>
