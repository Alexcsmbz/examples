...
export const SectionEndT = ({marketItems}: {marketItems?: MarketItem[]}) => {
  ...
  return (
    <CAdaptiveBox maxWidth="100vw" padding="0 20px" className="fade-in">
      <PBox marginBottom="40px">
        ...
        <PBox margin="0 -12px" className={slickSliderWrapper({device: 'tablet'})}>
          <Slider {...getListingCarouselSettings({slidesToShow: 3})} className={listingSlider}>
